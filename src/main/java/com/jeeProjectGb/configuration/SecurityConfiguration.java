package com.jeeProjectGb.configuration;
...
.antMatchers("/voiture/recherche").permitAll()
.antMatchers("/voiture/**").hasAuthority("ADMIN")
.antMatchers("/voiture/**").hasAuthority("USER").anyRequest()
.authenticated().and()
.csrf().disable().formLogin() // l'accès de fait via un formulaire
